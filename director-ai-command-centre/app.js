/* ============================================================
   DAD'S DIRECTOR AI COMMAND CENTRE — APP JS
   Pure vanilla JS. No dependencies. Offline only.
   ============================================================ */
...
const CATEGORIES = [
  ...
  { id: 'a',    label: 'Director OS Core',        icon: '🧭' },
  { id: 'b',    label: 'Project Oversight',       icon: '📊' },
  { id: 'c',    label: 'Decision-Making',         icon: '⚖️' },
  { id: 'd',    label: 'Fashion Retail',          icon: '👔' },
  { id: 'e',    label: 'Meetings & Comms',        icon: '🗣️' },
  { id: 'f',    label: 'Claude Hacks',            icon: '⚡' },
  { id: 'g',    label: 'Confidentiality',         icon: '🔒' },
];
...
const PROMPTS = [
  ...
  {
    id: 1, cat: 'a',
    title: 'Director Cockpit Master Prompt',
    for: 'Sets up Claude as your executive AI assistant with standing rules for every session.',
    when: 'Paste this at the start of every new Claude conversation or into your Claude Project system prompt.',
    prompt: `You are my executive AI assistant. I am a Senior Director at [COMPANY / BRAND], a major South African fashion and apparel retail brand.
...
Use this as your baseline context for our session. Confirm you have absorbed it and ask me one clarifying question if needed.`,
  ...
  {
    id: 2, cat: 'a',
    title: 'Weekly Director Briefing',
    for: 'Builds a structured weekly briefing from raw updates, emails, and team notes.',
    when: 'Monday morning — before your first key meeting of the week.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. It is [TIME PERIOD].
...
Format: Structured briefing with clear section headers. Ready to read in under 4 minutes.`,
  ...
  {
    id: 3, cat: 'a',
    title: 'Delta Update — What Changed Since Last Week',
    for: 'Extracts only genuine changes between last week and now — cuts through repetition.',
    when: 'Any time you want to update Claude without re-briefing it on everything. Also useful Friday afternoon.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND].
...
Format: Delta report — changes only, clearly labelled. Under 300 words.`,
  },
  {
    ...
    for: 'Scans your whole portfolio for risks across three urgency tiers: Red / Amber / Green.',
    when: 'End of week review, before a board meeting, or whenever things feel like they might be slipping.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND] reviewing [TIME PERIOD].
...
Format: Tiered risk table (RED / AMBER / GREEN) with narrative flags below.`,
  ...
  {
    id: 5, cat: 'a',
    title: '"What Needs My Attention?" Filter',
    for: 'Triages everything that has landed in your lap — tells you what to act on, delegate, or ignore.',
    when: 'Start of day, after returning from leave, or whenever your inbox feels unmanageable.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I have limited time and need to triage fast.
...
Format: Triage matrix — four clear sections with reasoning per item.`,
  ...
  /* ── B. PROJECT OVERSIGHT ────────────────────────────── */
  {
    ...
    for: 'An honest, structured health check across all key dimensions of a single project.',
    when: 'Weekly project reviews, before a steering committee, or when something feels off.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I am reviewing [PROJECT NAME].
...
Format: Health check dashboard — RAG indicators per section + concise bullets.`,
  ...
  {
    id: 7, cat: 'b',
    title: 'Project Rescue Mode',
    for: 'Crisis triage for a project in trouble. Root cause, stabilisation, and recovery plan.',
    when: '[PROJECT NAME] has missed a milestone, lost a key owner, or is at real risk of failure.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. [PROJECT NAME] is in trouble and I need to move fast.
...
Format: Rescue brief — clear headers, action-oriented, no filler. Under 500 words.`,
  ...
  {
    id: 8, cat: 'b',
    title: 'Red / Amber / Green Status Review',
    for: 'A clean RAG portfolio status across all active projects or workstreams at a glance.',
    when: 'Weekly portfolio review, monthly reporting pack, or before any governance meeting.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I am reviewing my full project portfolio for [TIME PERIOD].
...
Format: RAG table + portfolio summary. Scannable in 3 minutes.`,
  ...
  {
    id: 9, cat: 'b',
    title: 'Dependency and Blocker Map',
    for: 'Maps every blocker and dependency across your portfolio and tells you what you personally need to unblock.',
    when: 'When multiple projects feel stuck and you need to see the whole picture at once.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I need to understand what is blocking progress across [PROJECT NAME] or my full portfolio.
...
Format: Blocker table + dependency notes + prioritised action list.`,
  ...
  {
    id: 10, cat: 'b',
    title: 'Owner Accountability Review',
    for: 'Surfaces ownership gaps, conflicts, and accountability failures across a team or project.',
    when: 'When things are slipping and you\'re not sure who owns what — or when no one is driving.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I am reviewing accountability across [TEAM / DEPARTMENT] or [PROJECT NAME].
...
Format: Accountability table + intervention list. Direct and specific.`,
  ...
  {
    id: 11, cat: 'c',
    title: 'Director-Level Decision Memo',
    for: 'Structures any decision into a clear, Exco-ready memo — options, recommendation, rationale.',
    when: 'Before making any significant decision or escalating one to leadership.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND] and need to make or structure a decision about [DECISION NEEDED].
...
Format: Structured decision memo. Professional, direct, executive-ready.`,
  ...
  {
    id: 12, cat: 'c',
    title: 'Options and Trade-Offs Analysis',
    for: 'Cuts through pros/cons lists to expose what you\'re truly trading when choosing between options.',
    when: 'When a decision is genuinely difficult and the right answer isn\'t obvious.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I am evaluating options for [DECISION NEEDED].
...
Format: Trade-offs matrix per option + narrative recommendation.`,
  ...
  {
    id: 13, cat: 'c',
    title: 'CFO / COO / Brand Director Challenge',
    for: 'Red-teams your proposal the way a CFO, COO, and Brand Director would — before they do it to you.',
    when: 'Before presenting to Exco, the board, or any senior stakeholder who will push back hard.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND] preparing to defend [DECISION NEEDED] or [PROJECT NAME] in a senior leadership forum.
...
Format: Challenge brief — grouped by stakeholder perspective, with ranked severity.`,
  },
  {
    ...
    for: 'Tests the strength of your own position by identifying what evidence would reverse it.',
    when: 'When you\'re strongly committed to a direction and want to make sure you\'re not anchoring.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I have a current position on [DECISION NEEDED].
...
Format: Structured reflection — numbered, direct, under 350 words.`,
  ...
  {
    id: 15, cat: 'c',
    title: 'Approval Gate Checklist',
    for: 'A structured pre-approval checklist to ensure you\'re signing off on something that\'s actually ready.',
    when: 'Before giving approval on a project phase, budget release, supplier appointment, or major initiative.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. [PROJECT NAME] or [DECISION NEEDED] is approaching an approval gate and I need to decide whether to approve.
...
Format: Checklist table + recommendation statement. Direct.`,
  ...
  {
    id: 16, cat: 'd',
    title: 'Range Launch Readiness Review',
    for: 'A comprehensive pre-launch readiness check across all workstreams for a new range or season.',
    when: 'Two to four weeks before any range launch, key season drop, or collection go-live.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. We are preparing to launch [RANGE / SEASON].
...
Format: Readiness dashboard + Go/No-Go recommendation. Ready for a leadership review.`,
  },
  {
    ...
    for: 'A structured performance assessment of key suppliers — who is delivering and who needs action.',
    when: 'Quarterly supplier reviews, season-end assessments, or when supplier performance is a concern.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I am reviewing supplier performance for [TIME PERIOD].
...
Format: Scorecard table per supplier + strategic summary. Usable in a supplier review meeting.`,
  ...
  {
    id: 18, cat: 'd',
    title: 'Stock / Markdown Risk Review',
    for: 'Identifies over-stock positions, sell-through gaps, and markdown exposure before it\'s too late.',
    when: 'Mid-season, end of season, or whenever aged stock or sell-through is a concern.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND] reviewing stock and markdown risk for [TIME PERIOD] or [RANGE / SEASON].
...
7. Director decisions needed — what is only I can approve or initiate?
...
Format: Stock risk report — tiered by urgency + recommended actions with owners.`,
  ...
  {
    id: 19, cat: 'd',
    title: 'Store Rollout Readiness Review',
    for: 'Readiness check for a store opening, store refresh, or major in-store initiative rollout.',
    when: 'Two to three weeks before any store opening, store rebrand, or format rollout.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. We are rolling out [PROJECT NAME] — a store opening, refresh, or in-store initiative.
...
Format: Readiness dashboard per workstream + Go/No-Go call. Suitable for a store ops review.`,
  ...
  {
    id: 20, cat: 'd',
    title: 'Campaign Post-Mortem Review',
    for: 'A rigorous campaign post-mortem — what worked, what didn\'t, and what to lock in for next time.',
    when: 'Within two weeks of any campaign ending, while memory is fresh and data is available.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. [PROJECT NAME] campaign has concluded. I want a rigorous post-mortem.
...
Format: Structured post-mortem — What Worked / What Didn't / What Next.`,
  ...
  {
    id: 21, cat: 'd',
    title: 'Customer Impact Review',
    for: 'Assesses how a decision, project, or issue actually affects customers — and what to do about it.',
    when: 'Before launching anything customer-facing, or when an issue is affecting the customer experience.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I need to assess the customer impact of [PROJECT NAME] or [ISSUE].
...
Format: Customer impact brief — severity-rated with action recommendations and timeline.`,
  ...
  {
    id: 22, cat: 'd',
    title: 'Buying and Merchandising Meeting Prep',
    for: 'Prepares you for a buying or merchandising meeting — the right questions, key numbers, and your position.',
    when: 'Before any range review, OTB meeting, intake planning session, or buying sign-off meeting.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I am preparing for [MEETING NAME] — a buying and merchandising meeting for [RANGE / SEASON].
...
Format: Meeting prep pack — structured sections, scannable, ready to review 10 minutes before.`,
  ...
  /* ── E. MEETINGS AND COMMUNICATION ─────────────────── */
  {
    ...
    for: 'A complete pre-meeting briefing — context, objectives, questions, and your position.',
    when: 'Before any important meeting where you need to be sharp and prepared.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I have [MEETING NAME] coming up.
...
Format: Concise meeting prep pack — I should be able to brief myself in under 5 minutes.`,
  ...
  {
    id: 24, cat: 'e',
    title: 'Board / Exco Briefing Prep',
    for: 'Pressure-tests your Exco or Board briefing and prepares you for the hardest questions.',
    when: 'Before presenting to the Board, Exco, or any senior governance forum.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I am presenting to the Board or Exco on [PROJECT NAME] or [DECISION NEEDED].
...
Format: Briefing prep pack — structured sections with specific, direct guidance.`,
  },
  {
    ...
    for: 'Structures a difficult conversation so you\'re clear, direct, fair — and it achieves the right outcome.',
    when: 'Before any hard performance conversation, peer conflict, or stakeholder confrontation.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I need to have a difficult conversation about [ISSUE].
...
Format: Conversation prep guide — sequential, practical, scannable. Under 400 words.`,
  ...
  {
    id: 26, cat: 'e',
    title: 'Escalation Message Draft',
    for: 'Drafts a clear, professional escalation message — email and short form — that gets the right response.',
    when: 'When you need to escalate an issue to the CEO, Exco, or peer director and the message needs to land.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I need to escalate [ISSUE] to [describe the recipient — CEO, Exco, peer director, or team].
...
Format: Full email version + short message version + subject line.`,
  },
  {
    ...
    for: 'Extracts every action, decision, and follow-up from meeting notes — nothing slips through.',
    when: 'Immediately after any important meeting. Paste your rough notes and get a clean action log.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I have just completed [MEETING NAME].
...
Format: Clean action log — structured, specific, usable as minutes output within 10 minutes of the meeting.`,
  ...
  {
    id: 28, cat: 'f',
    title: '5-Line Prompt Formula',
    for: 'Converts any vague request into a powerful, precise Claude prompt in five lines.',
    when: 'Whenever you\'re about to paste something into Claude and it feels imprecise.',
    prompt: `Goal: Help me write a powerful, focused prompt for Claude using the 5-line formula.
...
Format: Final prompt in a clear block, ready to copy. Then brief notes.`,
  ...
  {
    id: 29, cat: 'f',
    title: 'Delta Mode Prompt',
    for: 'Updates Claude with new information without restarting the conversation or re-explaining context.',
    when: 'Any time you\'re in a live working session and want to give Claude new information efficiently.',
    prompt: `Goal: I want to update Claude with new information without restarting our conversation or re-explaining everything.
...
Director principle: A good Claude session is a conversation, not a series of restarts. Build context, don't repeat it.`,
  ...
  {
    id: 30, cat: 'f',
    title: 'No-Fluff Executive Summary Prompt',
    for: 'Gets a short, sharp executive summary from any document, report, or update — no padding.',
    when: 'Whenever someone sends you a long document and you need the 2-minute version.',
    prompt: `Goal: Get a tight, direct executive summary from any input.
...
Use this every time someone sends you a long document. Set this as a habit for all pre-read materials before meetings.`,
  ...
  {
    id: 31, cat: 'f',
    title: 'Reusable Context Block Builder',
    for: 'Builds a personal context block you can paste at the start of any Claude conversation — once, for life.',
    when: 'Set this up once and paste it at the start of every new Claude chat. Saves minutes every session.',
    prompt: `Goal: Build my personal reusable context block for Claude — so I never have to re-explain who I am or how I work.
...
Format: Full version + short version, clearly separated and ready to copy.`,
  },
  {
    ...
    for: 'Compresses a long or unwieldy prompt into something tighter and more powerful.',
    when: 'When a prompt you\'ve written feels too long, repetitive, or unfocused.',
    prompt: `Goal: I have a long or complicated prompt. Help me compress it into something shorter and more powerful — without losing the important parts.
...
Format: [Original] → [Compressed], with brief change notes.`,
  ...
  {
    id: 33, cat: 'f',
    title: '"Ask Only Essential Questions" Prompt',
    for: 'Stops Claude from asking unnecessary clarifying questions that slow you down.',
    when: 'Any time you want Claude to make progress and give you something to react to, rather than asking for perfect inputs.',
    prompt: `Goal: Stop Claude from asking unnecessary questions and get it to produce useful output immediately.
...
Director principle: You can always correct a draft. You cannot react to a blank page. Get something on paper first — refine from there.`,
  ...
  {
    id: 34, cat: 'g',
    title: 'Safe Input Sanitiser',
    for: 'Reviews any content you\'re about to paste into Claude and flags what should be removed or anonymised first.',
    when: 'Before pasting any internal document, report, email, or data into Claude.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I want to paste content into Claude and need to check it first.
...
Format: Flagged items list + sanitised version clearly separated.`,
  ...
  {
    id: 35, cat: 'g',
    title: 'Confidential Data Check',
    for: 'Assesses whether information you\'re planning to share with Claude is safe to share externally.',
    when: 'Before any Claude task that involves internal company data, financials, or people.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND] and I want to use Claude to help with a task involving potentially sensitive information.
...
Format: Risk rating + specific flags + safe alternative prompt I can use instead.`,
  ...
  {
    id: 36, cat: 'g',
    title: 'Public vs Internal vs Sensitive Classifier',
    for: 'Classifies any piece of information into Public / Internal / Sensitive so you know how to handle it.',
    when: 'Whenever you\'re unsure whether it\'s safe to paste something into Claude or share it externally.',
    prompt: `Context: I am a Senior Director at [COMPANY / BRAND]. I need to classify information before deciding how to handle it with AI tools.
...
Format: Classification + reasoning + handling instructions. Direct and specific.`,
  ...
  {
    id: 37, cat: 'g',
    title: '"Use Assumptions, Don\'t Invent Facts" Prompt',
    for: 'Locks Claude into honest, labelled reasoning — so you can trust its output for high-stakes decisions.',
    when: 'Any analytical task, risk assessment, financial review, or decision where accuracy is critical.',
    prompt: `Goal: Instruct Claude to be fully transparent about what it knows, what it's inferring, and what it doesn't know — so I can trust its output for decisions that matter.
...
const VAR_KEYS = [
  { key: '[COMPANY / BRAND]',   label: 'Company / Brand',    placeholder: 'e.g. Woolworths' },
  { key: '[PROJECT NAME]',      label: 'Project Name',       placeholder: 'e.g. Winter Range Launch' },
  { key: '[MEETING NAME]',      label: 'Meeting Name',       placeholder: 'e.g. Weekly Exco Briefing' },
  { key: '[TIME PERIOD]',       label: 'Time Period',        placeholder: 'e.g. Q3 2025 / Week 28' },
  { key: '[TEAM / DEPARTMENT]', label: 'Team / Department',  placeholder: 'e.g. Buying & Planning' },
  { key: '[ISSUE]',             label: 'Issue',              placeholder: 'e.g. Supplier delay on intake' },
];
...
function initBirthday() {
  ...
  const reopen   = document.getElementById('birthday-reopen');
...
function buildVariablesPanel() {
  ...
  VAR_KEYS.forEach(({ key, label, placeholder }) => {
  ...
  // Toggle
  const toggle = document.getElementById('var-toggle');
  const panel  = document.getElementById('var-panel-inner');
  toggle.addEventListener('click', () => {
    const open = panel.style.display !== 'none';
    panel.style.display = open ? 'none' : '';
    toggle.querySelector('.variables-toggle-icon').classList.toggle('open', !open);
    toggle.querySelector('.toggle-label').textContent = open ? 'Show Variables' : 'Hide Variables';
  });
}
...
function buildNav() {
  ...
  const mobileStrip = document.getElementById('mobile-nav-strip');
  ...
  CATEGORIES.forEach(cat => {
    ...
    btn.className = 'nav-btn' + (cat.id === 'all' ? ' active' : '');
    ...
    mBtn.className = 'mobile-nav-btn' + (cat.id === 'all' ? ' active' : '');
    mBtn.dataset.cat = cat.id;
    mBtn.textContent = cat.icon + ' ' + cat.label;
    mBtn.addEventListener('click', () => setCategory(cat.id));
...
function getFilteredPrompts() {
  return PROMPTS.filter(p => {
    ...
    const haystack = (p.title + ' ' + p.for + ' ' + p.when + ' ' + p.prompt).toLowerCase();
...
function buildCard(p, index) {
  ...
  const catLabelText = catLabel(p.cat).replace('Director OS Core', 'Director OS')
    .replace('Fashion Retail', 'Fashion Retail')
    .replace('Meetings & Comms', 'Meetings')
    .replace('Claude Hacks', 'Claude Hacks')
    .replace('Confidentiality', 'Confidentiality')
    .replace('Project Oversight', 'Projects')
    .replace('Decision-Making', 'Decisions');
  ...
  card.innerHTML = `
    <div class="card-header">
      ...
      <span class="cat-badge ${catBadgeClass(p.cat)}">${escHtml(catLabelText)}</span>
    </div>
    <div class="card-meta">
      <div class="meta-row">
        <span class="meta-label">What it's for</span>
        <span class="meta-value">${escHtml(p.for)}</span>
      </div>
      <div class="meta-row">
        <span class="meta-label">Best used when</span>
        <span class="meta-value">${escHtml(p.when)}</span>
      </div>
    </div>
    <div class="prompt-body">
      <button class="prompt-expand-btn" aria-expanded="false">
        <span>View full prompt text</span>
        <span>▼</span>
      </button>
      <div class="prompt-text-wrap" role="region">
        <pre class="prompt-text">${escHtml(p.prompt)}</pre>
      </div>
    </div>
    <div class="card-footer">
      <span class="placeholder-note">Fill in the variables above, then copy — bracketed placeholders will be replaced automatically.</span>
      <button class="copy-btn" data-prompt-id="${p.id}">
  ...
  const expandBtn  = card.querySelector('.prompt-expand-btn');
  const textWrap   = card.querySelector('.prompt-text-wrap');
  expandBtn.addEventListener('click', () => {
    const open = textWrap.classList.toggle('open');
    expandBtn.setAttribute('aria-expanded', String(open));
    expandBtn.querySelector('span:last-child').textContent = open ? '▲' : '▼';
    expandBtn.querySelector('span:first-child').textContent = open ? 'Hide prompt text' : 'View full prompt text';
  });

  // Copy button
  const copyBtn = card.querySelector('.copy-btn');
  copyBtn.addEventListener('click', () => copyPrompt(p, copyBtn));
...
function applyVars(text) {
  ...
  VAR_KEYS.forEach(({ key }) => {
    ...
    if (val) {
      // Replace all occurrences, case-sensitive (keys are fixed)
...
function copyPrompt(p, btn) {
  const processedText = applyVars(p.prompt);

  if (navigator.clipboard && navigator.clipboard.writeText) {
    navigator.clipboard.writeText(processedText).then(() => showCopied(btn)).catch(() => fallbackCopy(processedText, btn));
  } else {
    fallbackCopy(processedText, btn);
  }
}
...
function fallbackCopy(text, btn) {
  ...
  try {
    ...
    btn.querySelector('.copy-label').textContent = 'Copy failed — select text above';
  }
...
function showCopied(btn) {
  ...
  setTimeout(() => {
    ...
    btn.querySelector('.copy-icon').textContent = '⎘';
    btn.querySelector('.copy-label').textContent = 'Copy Prompt';
  }, 2200);
}
